 ...
 * to avoid double null checking in Printer class, we can go for Inner class.
 * and in that we can write INSTANCE variable and assign new Printer();
 * and call getInstance() which will return Inner class INSTANCE.
 */
public class App {
    public static void main(String[] args){
        ...
        System.out.println("Total Time :: for Inner Class:: " + (stopTime - startTime));
    }
}
